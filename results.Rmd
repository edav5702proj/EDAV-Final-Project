...
Below are the time series plot for the average waiting time changing pattern for each attraction in Disneyland. **Click** 
on the plots to zoom in. Through this juxtaposition, we can easily observed that the four trends and abnormalites that 
